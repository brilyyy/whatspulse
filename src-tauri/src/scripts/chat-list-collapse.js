...
(function () {
    ...
    var ID = 'whatspulse-collapse-nav';
    var STYLE_ID = 'whatspulse-chat-list-collapse';
    var PANE_ATTR = 'data-whatspulse-pane';
    var STORAGE_KEY = 'whatspulse:chatListCollapsed';
    ...
    function anchors() {
        ...
        // the avatar.
        var settings = document.getElementById('whatspulse-settings-nav');
